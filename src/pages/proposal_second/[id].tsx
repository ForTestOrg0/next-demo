...
export default function Page({ data, page, row, proposalId }: InferGetServerSidePropsType<typeof getServerSideProps>) {
  return (
    <PageContent>
      <Container className="flex-1">
        <Text block bold className="mb-4 break-all">
          For Democracy Proposal#{proposalId} ({data.count})
        </Text>
        <Boundary>
