...
import { FellowshipStatus } from './FellowshipStatus'
    ...
    <TableCol className="w-full">
      <tbody>
        ...
        <TrCol>
          ...
          <TdCol>
            <FellowshipStatus status={referendum?.status} />
          </TdCol>
        </TrCol>
        ...
        <TrCol>
          ...
          <TdCol>
            <VotePredict ayeAmount={referendum.ayes_amount} nayAmount={referendum.nays_amount} />
          </TdCol>
        </TrCol>
        <TrCol>
