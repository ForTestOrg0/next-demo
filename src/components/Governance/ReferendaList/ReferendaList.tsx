    ...
    {referendums.map((referendum) => {
      return (
        <Tr key={referendum.referendum_index}>
          <Td><ReferendaLink index={referendum.referendum_index} /></Td>
          <Td><BlockLink blockNumber={referendum.created_block}/></Td>
          <Td><Text>{referendum.vote_threshold}</Text></Td>
          <Td><ExtrinsicLink empty={!referendum.call_module} query={{module: referendum.call_module, call: referendum.call_name}}>{`${referendum.call_module} (${referendum.call_name})`}</ExtrinsicLink></Td>
          <Td><TimeFromNow date={referendum.block_timestamp}/></Td>
