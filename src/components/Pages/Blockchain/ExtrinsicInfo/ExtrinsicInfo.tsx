      ...
      <tbody>
        {extrinsic?.block_timestamp ? (
          <TrCol>
            ...
            <TdCol>
              <Time date={extrinsic?.block_timestamp} />
            </TdCol>
          </TrCol>
        ) : null}
        {extrinsic?.block_timestamp ? (
        ...
        <TrCol>
          ...
          <TdCol>
            <Flex className="items-center">
              <BlockStatus finalized={extrinsic.finalized} />
              <BlockLink blockNumber={extrinsic?.block_num} />
            </Flex>
          </TdCol>
        </TrCol>
        <TrCol>
        ...
        <TrCol>
          ...
          <TdCol>
            <ExtrinsicModule module={extrinsic.call_module} />
          </TdCol>
        </TrCol>
        <TrCol>
        ...
        <TrCol>
          ...
          <TdCol>
            <Parameters value={extrinsic.params.toString()} />
          </TdCol>
        </TrCol>
        <TrCol>
          <TdCol className="font-semibold whitespace-nowrap">Signature</TdCol>
          <TdCol>
            <Text>{extrinsic.signature}</Text>
          </TdCol>
        </TrCol>
      </tbody>
    </TableCol>
