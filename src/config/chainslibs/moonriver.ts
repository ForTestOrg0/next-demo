...
export const Moonriver: Chain = {
  id: 'moonriver',
  nativeTokenUniqueId: 'MOVR',
  name: 'Moonriver',
  type: 'mainnet',
  theme: {
    colors: ['#F2A006', '#F5CC7F', '#d7d7d7'],
    gradient: generateGradientColor('#d7d7d7', '#F2A006', 6),
  },
  gtag: 'G-K42R8Q9HNP',
  api: 'https://moonriver.webapi.subscan.io',
  domain: 'https://moonriver.subscan.io',
  subdomain: ['moonriver'],
  social: {
